...
const Achivesection = () => {
  return (
    <div className="relative w-full fade-up bg-white achieve-section">
      <div className="w-full">
        <div className="flex flex-cox-row justify-center fade-in">
          <div className="relative w-[20%] bg-[#111836] text-white flex flex-col justify-center left-side_clip">
          ...
          <div className="md:w-[44%] p-6 md:p-12">
            ...
            <div className="mb-4">
              ...
              <span className="text-gray-700">
                Now you can find a simple solution with schoolaura. In these
                days almost everyone has a Smartphone, Tab or Laptop. So just
                open your device and start your study from anywhere anytime
                while you are travelling, sitting in the park, and etc.
              </span>
            </div>

            <p className="text-gray-700">
              Now Use your time and gain knowledge in every second and Use your
              device for fade-upright things not for waste your time
            </p>
          </div>
        </div>
        ...
        <div className="relative w-[90%] ml-[15px]">
          <div
            className="relative flex justify-center fade-in"
          >
            <img
              src="./Layer-20.png"
